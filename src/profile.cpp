...
int main(int argc, char** argv) {
    ...
    cout << "Tc of f (REAL) (2 needles) : " << elapsed_time_secs(start_r,end_r) / ITER << "\n";
    cout << "Tc of f (CPU)  (2 needles) : " << elapsed_time_secs(start_cpu,end_cpu) / ITER << "\n";
